...
function (_Component) {
  ...
  function RegisterContainer() {
      ...
      return function (event) {
        ...
        if (name === 'stdID') {
          ...
          if (!value.charAt(0).match(firstCharRegex)) {
            var removeDoubleSpace = value.replace('  ', ' ');
            console.log('removeDoubleSpace', removeDoubleSpace);
            setValue(name, removeDoubleSpace.replace(nameRegex, ''));
          }
        } else {
          setValue(name, value);
        }
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "handleSubmitStep2", function () {
      ...
      console.log('asdasd', lodash_split__WEBPACK_IMPORTED_MODULE_13___default()(lodash_trim__WEBPACK_IMPORTED_MODULE_12___default()(formValues.name), ' '));
...
//# sourceMappingURL=index.js.deb7136454f8902568ad.hot-update.js.map